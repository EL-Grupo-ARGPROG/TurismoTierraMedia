...
public class Usuario {
	...
	public Usuario(int id, String username, String password, double presupuesto, double tiempoDisponible, TiposAtracciones preferencia, ArrayList<Vendible> itinerario2, boolean admin, int valid) {
		this.id = id;

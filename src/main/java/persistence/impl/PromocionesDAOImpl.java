...
import model.*;
import model.productos.Absoluta;
import model.productos.Atracciones;
import model.productos.AxB;
import model.productos.Porcentual;
...
public class PromocionesDAOImpl implements PromocionesDAO {
	...
	public Vendible finder(String name) {
			for(Vendible promocion : vendiblesList) {

	...
	<div class="row mt-5 bg-verde shadow">
		...
		<div class="flex-column shadow p-0 col-md-2 bg-obscure">
			...
			<div class="nav navbuttons flex-column py-2 justify-content-top">
				<a class="btn bg-verde-dark active btn-success" aria-current="page" href="/perfil-datos.jsp">Datos</a> 
				<a class="btn mt-1 mb-5 bg-verde-light btn-success" href="/TierraMedia/perfil-compras.jsp">Compras</a> 
				...
				<table class="table table-success table-striped table-hover">
					...
					<tbody>
						<c:forEach items="${vendiblesFiltrados}" var="vendible">
								<tr>
									<td><strong><c:out value="${itinerario.getNombre()}"></c:out></strong></td>

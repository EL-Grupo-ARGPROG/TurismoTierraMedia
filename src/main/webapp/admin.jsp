		...
		<div
			...
			<form action="tablaAdmin" method="get">
				<div class="container row justify-content-center">
					...
					<button
						class="btn row boton-filtro shadow btn-success bg-verde-light"
						type="submit">
						<i style="font-size: 1.5rem" class="bi bi-filter"></i>
					</button>
					<h5 class="text-center mt-1 mb-1 text-color-light col-sm-12">Nueva Atraccion</h5>
					<button
						class="btn row mt-1 boton-filtro shadow btn-success bg-verde-light"
